###! Autogenerated file by ./armbian-build/lib/tools/gen-library.sh to source all of repository functions and provide shellcheck derivative
...
# shellcheck source="./functions/cli/initiate.sh"
. "$SRC/lib/functions/cli/initiate.sh"
